  ...
  return (
    <main className="min-h-screen bg-white px-4 py-20 md:px-6 md:py-24">
      <article className="mx-auto max-w-3xl text-primary">
        ...
        <div className="mt-3 mb-10 h-[2px] w-10 bg-accent-greige" />

        <p className="mb-10 text-body-md leading-relaxed text-[#2D3748]">
          江口純一（以下「当方」といいます。）は、本サイトにおいて取得する個人情報について、以下のとおり適切に取り扱います。
        </p>

        <section className="mb-10 space-y-4">
          <h2 className="text-headline-sm text-primary">1. 取得する情報</h2>
          <p className="text-body-md leading-relaxed text-[#2D3748]">
            当方は、お問い合わせフォームを通じて、以下の情報を取得する場合があります。
          </p>
          <ul className="list-disc space-y-2 pl-5 text-body-md leading-relaxed text-[#2D3748]">
            <li>お名前・貴社名</li>
            <li>メールアドレス</li>
            <li>ご相談内容</li>
