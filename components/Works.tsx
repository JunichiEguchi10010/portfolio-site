      ...
      <div className="mx-auto max-w-container-max px-6">
        ...
        <div className="space-y-4">
          {works.map((work) => (
            <div
              key={work.title}
              className="flex cursor-pointer flex-col items-start justify-between gap-4 rounded-xl border border-outline-variant/30 bg-white p-6 shadow-sm transition-colors hover:bg-[#F5F7FA] md:flex-row md:items-center"
            >
              <div>
