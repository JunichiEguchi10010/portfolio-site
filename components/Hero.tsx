...
export default function Hero() {
  return (
    <section className="relative mx-auto grid max-w-container-max items-center gap-gutter px-6 py-section-gap-md md:grid-cols-2 md:gap-0 md:py-24">
      <div className="space-y-6 md:z-10 md:mr-[-40px] md:drop-shadow-sm">
        ...
        <div className="flex gap-4 pt-4">
          <a
            className="rounded-full bg-primary px-8 py-3 text-label-md text-on-primary shadow-sm transition-opacity hover:opacity-90"
            href="#contact"
          >
            業務の悩みを相談する
          </a>
          <a
            className="rounded-full border border-primary px-8 py-3 text-label-md text-primary transition-all hover:bg-white"
            href="#works"
          >
            制作実績を見る
          </a>
